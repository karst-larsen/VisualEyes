...
class App extends Component {
  constructor() {
    super();
    const sequenceOne = new Tone.Sequence(
      (time, note) => {
    ...
    const sequenceTwo = new Tone.Sequence(
      (time, note) => {
    ...
    let kickSequence = new Tone.Sequence(
      (time, note) => {
    ...
    let clapSequence = new Tone.Sequence(
      (time, note) => {
        this.state.drumSampler.player(note).start(time);
      },
      [],
    ...
    let hiHatSequence = new Tone.Sequence(
      (time, note) => {
        this.state.drumSampler.player(note).start(time);
      },
      [],
    ...
    let openHatSequence = new Tone.Sequence(
      (time, note) => {
        this.state.drumSampler.player(note).start(time);
      },
      [],
      ...
      <div className="App">
        ...
        <section className={`visual-container`}>
          ...
          <div className="visual-container__middle">
            <LeftSixth
              notes={this.state.leadSynthArray}
            ...
            <VisualEye
              ...
              steps={this.state.kickDrumArray}
              timeNode={this.state.selectedTimeNode}
              openHatArray={this.state.openHatArray}
            />
            <RightSixth
              notes={this.state.leadSynthArray}
              timeNode={this.state.selectedTimeNode}
          ...
          <div className="visual-container__bottom">
            <Squares
              notes={this.state.bassSynthArray}
              timeNode={this.state.selectedTimeNode}
                ...
                return (
                  <li
                    ...
                    className={`sequencer__note ${
                      kick.isActive ? "sequencer__note--active" : ""
                    } ${
                      this.state.selectedTimeNode === kickIndex
                        ? "sequencer__note--selected"
                        : ""
                    }`}
                    onClick={(e) => {
                      this.drumSequence(e, kickIndex, kick);
                    }}
                  >
                    •
                  </li>
              ...
              {this.state.clapSequencer.map((clap, clapIndex) => {
                return (
                  <li
                    key={clapIndex}
                    className={`sequencer__note ${
                      clap.isActive ? "sequencer__note--active" : ""
                    } ${
                      this.state.selectedTimeNode === clapIndex
                        ? "sequencer__note--selected"
                        : ""
                    }`}
                    onClick={(e) => {
                      this.clapSequence(e, clapIndex, clap);
                    }}
                  >
                    •
                  </li>
              ...
              {this.state.hiHatSequencer.map((hiHat, hiHatIndex) => {
                return (
                  <li
                    key={hiHatIndex}
                    className={`sequencer__note ${
                      hiHat.isActive ? "sequencer__note--active" : ""
                    } ${
                      this.state.selectedTimeNode === hiHatIndex
                        ? "sequencer__note--selected"
                        : ""
                    }`}
                    onClick={(e) => {
                      this.hiHatSequence(e, hiHatIndex, hiHat);
                    }}
                  >
                    •
                  </li>
              ...
              {this.state.openHatSequencer.map((openHat, openHatIndex) => {
                return (
                  <li
                    key={openHatIndex}
                    className={`sequencer__note ${
                      openHat.isActive ? "sequencer__note--active" : ""
                    } ${
                      this.state.selectedTimeNode === openHatIndex
                        ? "sequencer__note--selected"
                        : ""
                    }`}
                    onClick={(e) => {
                      this.openHatSequence(e, openHatIndex, openHat);
                    }}
                  >
                    •
                  </li>
